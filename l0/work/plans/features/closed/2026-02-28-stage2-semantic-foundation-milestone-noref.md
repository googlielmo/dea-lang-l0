...
Use the existing stdlib container surface for semantic tables. Create this plan document as the first commit. Update the
project status doc with durable wording that avoids fixed test counts.
