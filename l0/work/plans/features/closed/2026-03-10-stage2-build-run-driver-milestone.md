...
`work/plans/features/closed/2026-03-09-stdlib-runtime-fs-path-raw-io-bootstrap-noref.md`, which defers a general
...
3. The plan must explicitly reference the broader runtime plan:
   `work/plans/features/closed/2026-03-09-stdlib-runtime-fs-path-raw-io-bootstrap-noref.md` as the future home for a
...
5. Mention in the new milestone plan and any touched docs that the broader process API remains deferred to
   `work/plans/features/closed/2026-03-09-stdlib-runtime-fs-path-raw-io-bootstrap-noref.md` Phase 3.
