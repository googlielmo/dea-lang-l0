...
- Modules:
  ...
  - `work/plans/tools/attachments/blog-poll-workflow.yml`
...
New reference workflow at `work/plans/tools/attachments/blog-poll-workflow.yml`, to be copied into the blog repo:
