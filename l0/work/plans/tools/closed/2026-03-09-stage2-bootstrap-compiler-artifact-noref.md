...
`work/plans/features/closed/2026-03-11-triple-bootstrap-self-hosting-noref.md`. That follow-on work depends on this
...
2. Requiring Stage 2 self-hosting in this feature; that work is tracked in
   `work/plans/features/closed/2026-03-11-triple-bootstrap-self-hosting-noref.md`.
