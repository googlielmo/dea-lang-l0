...
01. Valid module/declaration parse.
02. Module header failures.
03. Reserved identifier/future-extension variable-name diagnostics.
04. Reserved operator diagnostics.
05. `with` form constraints.
06. `case` structure constraints.
07. Precedence correctness path.
08. Postfix chain path.
09. Type-expression call-argument path.
