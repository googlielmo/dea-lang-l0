...
This plan does not replace the narrower implementation plans already in `docs/plans/`. Instead, it records the current
top-level workflow inventory after those changes landed.

Existing related plans include:

- `docs/plans/tools/closed/2026-03-13-linux-ci-workflow.md`
- `docs/plans/tools/closed/2026-03-11-windows-build-support.md`
- `docs/plans/tools/closed/2026-03-04-release-oriented-docs-publishing-automation-noref.md`
- `docs/plans/tools/closed/2026-03-16-github-release-workflow-noref.md`
