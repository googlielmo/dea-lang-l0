...
- Modules:
    ...
    - `docs/plans/features/2026-03-09-stage2-bootstrap-compiler-artifact-noref.md`
- Test modules:
    - `compiler/stage2_l0/tests/l0c_triple_bootstrap_test.py`
    - `compiler/stage2_l0/tests/l0c_stage2_bootstrap_test.sh`
- Repro:
...
`docs/plans/features/2026-03-09-stage2-bootstrap-compiler-artifact-noref.md`. It does not change that plan’s Phase 3
