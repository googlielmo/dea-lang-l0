...
Stage 2 diverged from Stage 1 when the CLI target was path-like and no explicit `-P/--project-root` was provided.
For `examples/demo.l0`, Stage 1 normalized the target first and logged:
