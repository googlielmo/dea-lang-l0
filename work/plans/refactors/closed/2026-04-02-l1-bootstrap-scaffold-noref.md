...
At the same time, add a root `work/plans/` home for Dea-wide plans and extract a small shared launcher/env/bootstrap
...
1. Root `work/plans/` plus root `docs/reference/project-status.md` for Dea-wide planning/status material.
